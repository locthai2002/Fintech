...
print(f"The total sum of all loans in the list is {total_sum_of_all_loans}.")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
# YOUR CODE HERE!
average_loan_price = total_sum_of_all_loans/total_number_of_loans
print(f"The average loan amount from the list is {round(average_loan_price,2)}.")
...
if present_value >= loan_cost:
    print(f"Buy the loan! It is worth at least the cost to buy it. It's ${present_value: .2f}, which is more than the loan price of ${loan_cost}.")
else:
...
present_value = present_value_function(new_loan["future_value"],new_loan["remaining_months"],annual_discount_rate)
...
with open(output_path, "w") as csvfile:
    ...
    # @TODO: Write the values of each dictionary inside of `inexpensive_loans`
